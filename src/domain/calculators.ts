...
export const CALCULATORS_BY_TRANSACTION: Record<string, string[]> = {
  ...
  switch_transfer: ['rate-comparison-calculator', 'mortgage-penalty-calculator',
  ...
  debt_consolidation: ['debt-consolidation-calculator', 'cost-of-ownership-calculator',
                       'home-equity-calculator'],
  heloc: ['heloc-calculator', 'home-equity-calculator'],
  second_mortgage: ['home-equity-calculator', 'private-mortgage-calculator',
                    'debt-consolidation-calculator'],
  rental_investment: ['rental-property-calculator', 'cost-of-ownership-calculator',
                      'gds-tds-calculator'],
  ...
  other: ['mortgage-payment-calculator', 'mortgage-affordability-calculator'],
};
